...
clear
[[ "$(whoami)" != "root" ]] && {
    echo -e "\033[1;33m[\033[1;31mErro\033[1;33m] \033[1;37m- \033[1;33you need to run as root\033[0m"
...
tput setab 4
tput bold
printf '%40s%s%-12s\n' "WELCOME TO KumulTricks SSH MANAGER"
tput sgr0
echo -e "\033[1;31m════════════════════════════════════════════════════\033[0m"
echo ""
...
echo ""
echo -e "\033[1;32m• \033[1;32mTIP! \033[1;33mUSE THE DARK THEME ON YOUR TERMINAL TO\033[0m"
echo -e "\033[1;33m  A BETTER EXPERIENCE AND VIEW OF IT!\033[0m"
echo ""
echo -e "\033[1;31m≠×≠×≠×≠×≠×≠×≠×[\033[1;33m • \033[1;32mEDIT:@squid675\033[1;33m •\033[1;31m ]≠×≠×≠×≠×≠×≠×≠×\033[0m"
echo ""
#-----------------------------------------------------------------------------------------------------------------
echo -ne "\033[1;36mGENERATING A FREE KEY [N/S]: \033[1;37m"
read x
[[ $x = @(n|N) ]] && exit
...
if [[ "$resposta" = '1' ]]; then
    ...
    wget -P $_Ink https://raw.githubusercontent.com/kumultricks/KumulSSH/master/Install/list >/dev/null 2>&1
    verif_key
    sleep 3s
    echo "/bin/menu" >/bin/h && chmod +x /bin/h >/dev/null 2>&1
    rm versao* >/dev/null 2>&1
    wget https://raw.githubusercontent.com/kumultricks/KumulSSH/master/Install/versao >/dev/null 2>&1
    >/dev/null 2>&1
    ...
    wget https://raw.githubusercontent.com/kumultricks/KumulSSH/main/Modulos/v2raymanager >/dev/null 2>&1
    ...
    cd $HOME/BOT
    wget https://raw.githubusercontent.com/kumultricks/KumulSSH/master/Sistema/ShellBot.sh >/dev/null 2>&1
    chmod 777 ShellBot.sh >/dev/null 2>&1
    cd >/dev/null 2>&1
    #-----------------------------------------------------------------------------------------------------------------
    echo -e "\n\033[1;32mVALID KEY!\033[1;32m"
    sleep 1s
    echo ""
    [[ -f "$HOME/usuarios.db" ]] && {
        clear
        ...
        echo ""
        echo -e "\033[1;33mA User Database \033[1;32m(usuarios.db) \033[1;33mHe was"
        echo -e "Found! Want to keep it preserving the limit"
        echo -e "of simultaneous user connections? Or do you want"
    ...
    echo -e "\033[1;33m MORE INFORMATION \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@KUMULTRICKS\033[0m"
    ...
    echo ""
    echo -e "\033[1;31m \033[1;33mMAIN COMMAND: \033[1;32mmenu\033[0m"
    echo -e "\033[1;33m MAIS INFORMACOES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@KUMULTRICKS\033[0m"
    rm $HOME/Plus && cat /dev/null >~/.bash_history && history -c
